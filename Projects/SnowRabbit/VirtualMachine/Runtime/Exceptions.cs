...
namespace SnowRabbit.VirtualMachine.Runtime
{
    ...
    /// </summary>
    [Serializable]
    public class SrOutOfMemoryException : SrException
    {
        /// <summary>
        /// SrOutOfMemoryException のインスタンスを初期化します
        /// </summary>
        public SrOutOfMemoryException() : base()
        {
        }
        ...
        /// </summary>
        /// <param name="message">発生した例外のメッセージ</param>
        public SrOutOfMemoryException(string message) : base(message)
        {
        }
        ...
        /// <param name="message">発生した例外のメッセージ</param>
        /// <param name="innerException">この例外を発生させた原因の例外</param>
        public SrOutOfMemoryException(string message, Exception innerException) : base(message, innerException)
        {
        }


        /// <summary>
        /// シリアル化したデータから SrOutOfMemoryException のインスタンスを初期化します
        /// </summary>
        /// <param name="info">シリアル化されたオブジェクト情報</param>
        /// <param name="context">シリアルデータの転送コンテキスト</param>
        protected SrOutOfMemoryException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        }
    }
}