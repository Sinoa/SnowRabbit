...
namespace SnowRabbit.RuntimeEngine
{
    ...
    public readonly struct MemoryBlock<T> : IEquatable<MemoryBlock<T>>
    {
        ...
        /// <summary>
        /// MemoryBlock の等価確認をします
        /// </summary>
        /// <param name="other">比較対象</param>
        /// <returns>等価の場合は true を、非等価の場合は false を返します</returns>
        public bool Equals(MemoryBlock<T> other) => memoryPool == other.memoryPool && Offset == other.Offset && Length == other.Length;
        ...
        /// <returns>等価の場合は true を、非等価の場合は false を返します</returns>
        public override bool Equals(object obj) => obj is MemoryBlock<T> ? Equals((MemoryBlock<T>)obj) : false;
        ...
        public static bool operator ==(MemoryBlock<T> left, MemoryBlock<T> right) => left.Equals(right);
