...
{
    /// <summary>
    /// ログ出力操作を一切しないNULLログハンドラクラスです
    /// </summary>
    internal sealed class SrNullLogHandler : ISrLogHandler
    {
        /// <summary>
        /// SrNullLogHandler へのインスタンス
        /// </summary>
        public static readonly ISrLogHandler Instance = new SrNullLogHandler();
