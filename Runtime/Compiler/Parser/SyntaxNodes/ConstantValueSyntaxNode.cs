...
namespace SnowRabbit.Compiler.Parser.SyntaxNodes
{
    ...
    /// 定数値構文を表す構文ノードクラスです
    /// </summary>
    public class ConstantValueSyntaxNode : SyntaxNode
    {
        // メンバ変数定義
        private Token value;
        ...
        {
            // int値, number値, string値 のいずれかどうかを判断する
            ...
            var constantValue = new ConstantValueSyntaxNode();
            constantValue.value = token;
