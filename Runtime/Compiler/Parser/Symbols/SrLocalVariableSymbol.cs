...
namespace SnowRabbit.Compiler.Parser.Symbols
{
    ...
    public abstract class SrLocalVariableSymbol : SrSymbol
    {
        ...
        /// <param name="functionSymbol">このローカル変数を持つ関数シンボル</param>
        protected SrLocalVariableSymbol(string name, int initialAddress, SrFunctionSymbol functionSymbol) : base(name, initialAddress)
        {
            // 所属する関数シンボルを覚える
        ...
        protected override string Mangling()
        {
            ...
            return mangledName ?? (mangledName = $"___SR_LV_{FunctionSymbol.Name}_{Name}___");
        }
    }
    ...
    public class SrLocalVariableSymbol<T> : SrLocalVariableSymbol
    {
        ...
        /// <param name="initialAddress">初期アドレス</param>
        /// <param name="functionSymbol">このローカル変数を持つ関数シンボル</param>
        public SrLocalVariableSymbol(string name, int initialAddress, SrFunctionSymbol functionSymbol) : base(name, initialAddress, functionSymbol)
        {
        }
    }
}
