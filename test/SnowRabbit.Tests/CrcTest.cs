...
public class CrcTest
{
    ...
    public void CrcCalculateTest()
    {
        ...
        uint crc32Expected = 0x86BD72E6U;
        ulong crc64Expected = 0xE42D8FC1542F78D3UL;


        // CRC32のテスト
        Crc32Standard crc32 = new Crc32Standard();
        uint result32 = crc32.Calculate(testData);
        Assert.That(result32, Is.EqualTo(crc32Expected));
