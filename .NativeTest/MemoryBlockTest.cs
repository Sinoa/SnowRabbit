...
namespace SnowRabbitTest
{
    ...
    public class MemoryBlockTest
    {
        ...
        public unsafe void ItemAccessTest()
        {
            ...
            Assert.AreEqual(valueA, memoryPool[0].Primitive.Int);
            Assert.AreEqual(valueB, memoryPool[50].Primitive.Int);
            Assert.AreEqual(valueD, memoryPool[25].Primitive.Int);
            Assert.AreEqual(valueA, memoryBlockC[0].Primitive.Int);
            Assert.AreEqual(valueB, memoryBlockC[50].Primitive.Int);
            Assert.AreEqual(valueD, memoryBlockC[25].Primitive.Int);
        }
